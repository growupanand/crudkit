...
module.exports = {
  types: [
    {
      value: "chore",
      name: "chore:    🤖  Worked on something that is not a feature or a fix, and should not show in release notes",
      emoji: "🤖",
    },
    ...
    {
      value: "refactor",
      name: "refactor: 💡  A code change that neither fixes a bug nor adds a feature, but should show in release notes",
      emoji: "💡",
    },
